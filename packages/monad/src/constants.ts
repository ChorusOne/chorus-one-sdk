...
/**
 * Monad Staking Contract Constants
 */

// Monad Staking Contract Address (precompile)
export const MONAD_STAKING_CONTRACT_ADDRESS = '0x0000000000000000000000000000000000001000'

// Monad Chain ID (for reference - SDK fetches from RPC)
export const MONAD_CHAIN_ID = 30143

// Minimum stake amount in MON (for validator registration)
export const MIN_VALIDATOR_STAKE_MON = 1_000_000

// Withdrawal delay in epochs
export const WITHDRAWAL_DELAY = 1

/**
 * Monad Staking Contract ABI
 * Full ABI for the staking precompile contract
 */
