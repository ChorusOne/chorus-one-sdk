---
description: >-
  An overview of the newest developments in crypto staking and how to get
  involved.
icon: book-open
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/KGu77aAU8HQJ5FTwSgOi/getting-started/staking-concepts
---
...
While we covered the overall gist of how staking works in our [staking-overview.md](../staking-overview.md "mention"), there are many nuances and different concepts in the world of staking that vary from network to network.&#x20;
...
* Comprehensive rewards reporting directly from Chorus One or via [chorus-one-rewards.md](../../our-products/chorus-one-rewards.md "mention")
